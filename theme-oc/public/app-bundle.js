...
var _PartyTheme = __webpack_require__(27);

var _PartyTheme2 = _interopRequireDefault(_PartyTheme);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var content = document.__DATA__;
console.log("in app.js");
console.dir(content);
(0, _reactDom.render)(_react2.default.createElement(_PartyTheme2.default, { data: content.party }), document.getElementById("root-theme"));
...
function PartyTheme(props) {
    console.log("in party theme");
    console.dir(props);
    var _props$data = props.data,
        name = _props$data.name,
        partyInfo = _props$data.partyInfo;
